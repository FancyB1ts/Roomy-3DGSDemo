...
public class PlacementManager : MonoBehaviour
{
    ...
    public bool IsFurnitureInteractionActive { get; private set; }
   ...
   public BuildingState buildingState;
    ...
    public UnityEvent OnExitPlacementMode, OnPlaceConstructionObject, OnPlaceFurnitureObject, OnRemoveObject, OnUndo,  OnExitMovement, OnMovementStateEntered;
    public UnityEvent<bool> OnToggleUndo;
    public UnityEvent<int> OnRotate;
    private void Start()
    {
    ...
    public void HandleRotation(int modifier)
    {
        buildingState.HandleRotation(modifier);
        OnRotate?.Invoke(modifier);
    }
    ...
    private void HandleSelectionStarted()
    {
        ...
        IsFurnitureInteractionActive = true; // Signal we're handling input
        
        if (buildingState == null)
        {
            IsFurnitureInteractionActive = false; // No valid interaction
    ...
    {
        IsFurnitureInteractionActive = false; // Always reset
