Shader "Lpk/LightModel/ToonLightBase"
{
    Properties
    {
        ...
        _ShadowIntensity    ("ShadowIntensity", Range(0, 1))      = 0.8
        ...
        Pass
        {
            ...
            float4 frag(Varyings input) : SV_Target
            {
               ...
               float shadowNL = smoothstep(_ShadowStep - _ShadowStepSmooth, _ShadowStep + _ShadowStepSmooth, NL);
                ...
                //diffuse
                float3 diffuse = _MainLightColor.rgb * baseMap * _BaseColor * (shadowNL * shadow * _ShadowIntensity + (1.0 - _ShadowIntensity));
